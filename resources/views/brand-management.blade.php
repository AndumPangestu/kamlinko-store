<x-app-layout>
    ...
    <x-slot name="headerDesc">
        {{ __('Welcome to your brand management!') }}
    </x-slot>
    ...
    <div class="py-12">
        <div class="">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @endif
                <div class="text-gray-900 dark:text-gray-100" id="brand-list">
                    @include('components.brand.brand-list', ['data' => $data])
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        searchInput.addEventListener('keyup', function() {
            ...
            fetch(`{{ route('admin.brand-management') }}?search=${query}`, {
                    headers: {
                ...
                .then(data => {
                    document.getElementById('brand-list').innerHTML = data;
                });
        });
    });
</script>